...
#     client = Client()
#     client.set_endpoint(app.config['APPWRITE_ENDPOINT'])
#     client.set_project(app.config['APPWRITE_PROJECT_ID'])
    
#     # For server-side API access, use API key instead of account sessions
#     try:
#         account = Account(client)
#         session = account.create_anonymous_session()
#         print("Created anonymous Appwrite session")
#     except Exception as e:
#         print(f"Warning: Couldn't create anonymous session - {e}")
...
#             # Create session
#             session_response = account.create_email_session(email, password)
#             session['user_id'] = session_response['$id']
#             session['email'] = email
...
#         # If you want to also delete the session on Appwrite server
#         if 'user_id' in session:
#             client = initialize_appwrite_client()
#             account = Account(client)
#             account.delete_session(session['user_id'])
#     except Exception as e:
